...
```bash
git clone https://github.com/maxfrank76/5s-system.git
cd 5s-system
```
...
**НЕ ИСПОЛЬЗУЙТЕ ЭТУ СИСТЕМУ В ПРОДУКШЕННОЙ СРЕДЕ!**
...
*Это прототип системы. Используйте для ознакомления и тестирования концепции.*
```